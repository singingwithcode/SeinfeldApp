class EpisodeCount {
    ...
    */
    ...
    updateVis() {
        ...
        vis.yScale.domain([1, d3.max(vis.aggregatedData, vis.yValue) + 25]);
    ...
    renderVis() {
        ...
        const bars = vis.chart.selectAll('.bar')
            .data(vis.aggregatedData, d => d.Character, d => d.SEID)
            .join('rect')
            .attr('class', 'bar')
            ...
            .on('mouseover', (event, d) => {
                d3.select('#tooltip2')
                    ...
                    .html(`<div class="tooltip-title2">Episodes Appeared In</div><ul>${d3.format(',')(d.count)} </ul>`);
            })
            .on('mouseleave', () => {
